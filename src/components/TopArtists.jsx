    ...
    return (
        <>
            <div className={'relative btn h-full w-full'}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65" height="65" width="65" className={'group-hover:scale-150 transition duration-[800ms] ease-in-out'}>
                    <g opacity="1">
                        <g className="Button_expandCorner__3vMId" opacity="1">
                            <path id="pG7erTBY" opacity="1" fillRule="evenodd"
                                  ...
                                  fill="rgb(122,129,133)" fillOpacity="1"></path>
                        </g>
                        <g className="Button_expandCorner__3vMId" opacity="1">
                            <path id="phYVgv23H" opacity="1" fillRule="evenodd"
                                  d="M4,5.5 L4,11.25 L7,11.25 L7,7 L11.25,7 L11.25,4 L5.5,4 C4.674799999999999,4 4,4.674799999999999 4,5.5Z"
                                  fill="rgb(122,129,133)" fillOpacity="1"></path>
                        </g>
                        <g className="Button_expandCorner__3vMId" opacity="1">
                            <path id="pNY234Ybv" opacity="1" fillRule="evenodd"
                        ...
                        <g className="Button_expandCorner__3vMId" opacity="1">
                            <path id="pnYGvr23" opacity="1" fillRule="evenodd"
                ...
                <div className={'absolute inset-0 h-full w-full flex flex-col items-center justify-center'}>
                    <span> 50 </span>
                    <label htmlFor={'top-artists-modal'} className={'absolute w-full h-full'}> </label>
                </div>
            </div>
